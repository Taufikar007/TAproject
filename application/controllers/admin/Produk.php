...
class Produk extends CI_Controller {
	...
	public function tambah()
	{
		...
		// Masuk database
			...
			$i = $this->input;
			$data = array(	'ID_WAKTU'					=> $this->session->userdata('ID_WAKTU'),
							'ID_JENIS_WAKTU'			=> $i->post('ID_JENIS_WAKTU'),
							'LAMA_WAKTU'				=> $i->post('LAMA_WAKTU'),
							'HARGA_WAKTU'				=> $i->post('HARGA_WAKTU'),
	...
	public function edit($id_produk)
	{
		...
		$valid->set_rules('LAMA_WAKTU','Nama Produk','required',
			array(	'required'			=>'%s harus diisi'));
		...
		// Masuk database
			...
			// End create thumbnail gambar
			$i = $this->input;
			$data = array(	'ID_WAKTU'					=> $id_produk,
							'ID_WAKTU'					=> $this->session->userdata('ID_WAKTU'),
							'ID_JENIS_WAKTU'			=> $i->post('ID_JENIS_WAKTU'),
							'LAMA_WAKTU'				=> $i->post('LAMA_WAKTU'),
							'HARGA_WAKTU'				=> $i->post('HARGA_WAKTU'),
							'GAMBAR'					=> $upload_gambar['upload_data']['file_name']
