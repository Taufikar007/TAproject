...
class Jenis extends CI_Controller {
	...
	public function tambah()
	{
		...
		$valid->set_rules('LAMA_JENIS_WAKTU','Nama_jenis','required|min_length[5]|max_length[32]|is_unique[JENIS_WAKTU.LAMA_JENIS_WAKTU]',
		...
		// Masuk database
			...
			$i = $this->input;
			$data = array(	'LAMA_JENIS_WAKTU'			=> $i->post('LAMA_JENIS_WAKTU'));
	...
	public function edit($id_jenis)
	{
		...
		// Masuk database
			...
			$i = $this->input;
			$data = array(	'ID_JENIS_WAKTU'			=> $id_jenis,
							'LAMA_JENIS_WAKTU'		=> $i->post('LAMA_JENIS_WAKTU')
						);
